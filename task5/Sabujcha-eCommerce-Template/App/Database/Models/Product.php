...
class product extends similar implements band{
    private $id,$name_en,$name_ar,$image,$price,$details_en,$details_ar,$quantity,$status,$created_at,$updated_at , $subcategory_id, $brand_id;
