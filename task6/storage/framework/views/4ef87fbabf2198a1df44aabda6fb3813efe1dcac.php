                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('dashboard.products.all')); ?>" class="nav-link">
...
<?php /**PATH E:\programs\xampp\htdocs\phpcourse\project\Project-laravel\resources\views/layouts/parent.blade.php ENDPATH**/ ?>