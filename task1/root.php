<?php
        switch ($_SERVER['REQUEST_METHOD']){
            case 'POST':
                define('POWER_DIVIDING_TOP' , 1);
                $message = pow($_POST['number'] , (POWER_DIVIDING_TOP/$_POST['power']));
                echo $message;
                break;
            case 'GET':
                echo "";
    ...
    <body>
        <div class="container">
                <form action="" method="POST" class="col-6 offset-3 p-5 border border-danger mt-5">
                    ...
                    <div class="form-group">
                        <label for="Enter Power">Enter Power</label>
                        <input type="number" name="power" id="" class="form-control" placeholder="" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
